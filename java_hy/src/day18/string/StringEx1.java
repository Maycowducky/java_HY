...
public class StringEx1 {
	...
	public static void main(String[] args) {
		...
		//소문자 대문자 구분해서 sysout에 적용
		String str = "Hello World";
		
		//뒤에 숫자가 들어가면 n번지 부터 시작해서 wo를 찾는다
		//str에서 7번지부터 wo가 있는지 확인 orld에서 wo가 있는지 확인
		// → 없음 → -1
		//소문자 대문자 구분해서 sysout에 적용
		...
		//replace : 특정 문자 / 문자열을 바꿀 때 사용. 첫번째 문자/ 문자열만 수정
		//replace all: 정규 표현식에 맞는 모든 문자 / 문자열을 수정
	...
	System.out.println(str + "에서 0번지부터 " + "o" + "오른쪽부터 있나요? " + index);
	...
	// \n ENTER \t TAB
	String str4 = "\n\t\tabc\t\tdef\t\n";
	//trim() 첫단어 첫글자와 마지막단어 마지막글자 공백을 제거해줌
	//시작문자(a) 전 공백, 마지막문자 (f) 후 공백을 제거, 사이에있는 공백은 제거 못함
