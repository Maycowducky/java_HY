...
public class AccessModifierEx {
	...
	public static void main(String[] args) {
		...
		//num3은 같은 패키지이든 아니든 상관없음
		a.num3 = 10;
		b.num3 = 20;
		
		//num2는 접근제어자가 디폴트(생략됨). 다른 패키지에 있는 B 클래스의 객체는 접근이 안됨
		a.num2 = 10;
		//b.num2 = 20;
		
		//num1은 접ㄱ근제어자가 private.
...
class A{
	...
	int num2;
	public int num3;
	/** 클래스 A의 객체 정보 num1을 출력하는 method
	 * 매개변수 : 없음 → 이미 알고있는 내 정보를 num1이기 때문에
	 * 리턴타입 : 없음 → void
	 * 메서드명 : print
	 */
	public void print() {
