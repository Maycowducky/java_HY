...
public class ClassInheritanceEx {
	...
	public static void main(String[] args) {
		 ...
		 *  → default는 같은 package인 경우는 가능하나 다른 package이면 불가능
		 */
		...
		//다운 캐스팅 : 안되는 경우
		Phone p1 = new Phone("010-1231-3456");
...
class Phone {
	...
	//public Phone(){} 
	// 생성자가 하나도 없으면 compile할 때 기본 생성자가 자동으로 추가 됨
}
class SmartPhone extends Phone{ //상속 받는것을 사용할때 extends class명
	...
	@Override // override 문법에 맞는지 체크할때
	//public void call(String num,String num2) { // Overloading
	public void call(String num) {
		super.call(num); 
		//부모클래스의 있는 call을 Override 한다 하지만 거의 안씀.
		System.out.println("SmartPhone!");
	}
}
class Camera { //스마트폰은 카메라가 아니기때문에 상속(extends) 불가
	public void take() {
