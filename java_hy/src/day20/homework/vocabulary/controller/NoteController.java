package day20.homework.vocabulary.controller;
...
public class NoteController implements RunInterface{
	...
	private void updateWord() {
		...
		case 2:
			...
			System.out.print("단어: ");
			String title = sc.next();
			//단어를 출력을 출력하고, 단어가 없으면 안내문구 출력 후 종료
