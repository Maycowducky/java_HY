...
public class ListEx {
	...
	public static void main(String[] args) {
		...
		//1을 제거 (Integer)을 안붙이면 int로 인식을해서 2가 제거됨
		...
		//현재 저장된 객체 수를 출력. 저장 가능한 최대 객체 수가 아님.
		...
		while(it.hasNext()) { //hasNext가 거짓이 될 때까지 반복
			Integer tmp = it.next();
			System.out.print(tmp + " ");
		}
		System.out.println();
		//그외 기능들
		System.out.println(list.contains(1));//List에 1이 있는지 없는지 확인. 요소를 찾을때 사용.
