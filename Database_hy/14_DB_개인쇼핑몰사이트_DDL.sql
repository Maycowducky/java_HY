...
CREATE TABLE `shopping_cart` (
	...
	`sc_amount`	int	NOT NULL DEFAULT 1,
	`sc_me_id`	varchar(15)	NOT NULL,
...
ALTER TABLE `shopping_cart` ADD CONSTRAINT `FK_member_TO_shopping_cart_1` FOREIGN KEY (
	`sc_me_id`
)
REFERENCES `member` (
	`me_id`
...
ALTER TABLE `shopping_cart` ADD CONSTRAINT `FK_option_TO_shopping_cart_1` FOREIGN KEY (
	`sc_op_num`
)
REFERENCES `option` (
	`op_num`
